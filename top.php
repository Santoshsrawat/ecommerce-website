...
$obj = new add_to_cart();
$totalProduct = 0;  // Set a default value

if (isset($_SESSION['USER_ID'])) {
    $user_id = $_SESSION['USER_ID'];
    $totalProduct = $obj->totalProduct($user_id);
}
...
<body>
    ...
    <div class="asbab">
        <div class="header__right">
            ...
            <div class="header__account text-white">
            ...
            <div class="htc__shopping__cart">
                <?php if (isset($_SESSION['USER_ID'])) : ?>
                    <a href="wishlist.php" class="mr15"><i class="icon-heart icons" style="color: white;"></i></a>
                    <a href="wishlist.php"><span class="htc__wishlist"><?php echo $wishlist_count; ?></span></a>
                <?php endif; ?>
                <a href="cart.php" style="margin-right: 30px;"><i class="icon-handbag icons"></i></a>
                <a href="cart.php" style="margin-right: 30px;"><span class="htc__qua"><?php echo $totalProduct; ?></span></a>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                                <div class="logo">
                                    <a href="index.php"><img src="images/logo/4.svg" alt="logo images"></a>
                                </div>
                            </div>
