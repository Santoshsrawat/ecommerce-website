...
$coupon_value = (int)$coupon_details['coupon_value']; // Ensure $coupon_value is an integer
...
if($coupon_value > 0){ // Check if coupon value is greater than zero
    $html .= '<tr>
                <td colspan="3"></td>
...
$total_price = max(0, $total_price - $coupon_value); // Ensure total_price is not negative
$html .= '<tr>
                <td colspan="3"></td>
